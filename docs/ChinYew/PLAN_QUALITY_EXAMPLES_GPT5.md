...
> **Purpose:** Demonstrate two-layer evaluation: Structural (S1-S10) + Grounding (G1-G5)
...
| Scenario | Structural (S1-S10) | Grounding (G1-G5) | Verdict |
|----------|---------------------|-------------------|---------|
...
- Structural: ≥60/100 with all critical patterns (S1, S2, S3, S9) passing
